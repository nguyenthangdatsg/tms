    ...
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">{{ __t('enrolment') }}: {{ $targetName }}</h5>
            ...
            <div class="modal-body">
                <div class="col-12 mb-3">
                    <ul class="nav nav-pills" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link {{ $activeTab == 1 ? 'active' : '' }}" wire:click="setActiveTab(1)" type="button" role="tab">{{ __t('enrolled_users') }}</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link {{ $activeTab == 2 ? 'active' : '' }}" wire:click="setActiveTab(2)" type="button" role="tab">{{ __t('enroll_user') }}</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link {{ $activeTab == 3 ? 'active' : '' }}" wire:click="setActiveTab(3)" type="button" role="tab">{{ __t('enroll_cohort') }}</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link {{ $activeTab == 4 ? 'active' : '' }}" wire:click="setActiveTab(4)" type="button" role="tab">{{ __t('import_excel') }}</button>
                        </li>
                    </ul>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="border rounded p-3" style="max-height: 250px; overflow-y: auto;">
                        <table class="table table-sm table-hover">
                            ...
                            <tbody>
                                @foreach($filteredEnrolledUsers as $user)
                                <tr>
                                    <td>
                ...
                <div class="mb-3">
                    ...
                    <div class="border rounded p-3" style="max-height: 250px; overflow-y: auto;">
                        @if(count($filteredEnrollUsers) > 0)
                        <table class="table table-sm table-hover">
                            <thead>
                                <tr>
                                    <th style="width: 40px;"></th>
                            ...
                            <tbody>
                                @foreach($filteredEnrollUsers as $user)
                                <tr>
                                    <td>
                                        <input class="form-check-input" type="checkbox" 
            ...
            <div class="modal-footer">
                ...
                @if($activeTab == 2)
                <button type="button" class="btn btn-success" wire:click="enrolUser()" wire:loading.attr="disabled">
