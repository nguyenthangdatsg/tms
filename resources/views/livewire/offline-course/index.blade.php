<div>
    <div class="row mb-4">
        <div class="col-12 d-flex justify-content-between align-items-center">
            <h2 class="mb-0">{{ __t('offline_course') }}</h2>
            ...
            <div class="table-responsive">
                <table class="table table-hover table-responsive-md mb-0">
                    ...
                    <tbody>
                        ...
                        @empty
                        <tr>
                            <td colspan="8" class="px-4 py-4 text-center text-muted">{{ __t('no_offline_courses') }}</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
    ...
    @php $maxPages = min($paginatedCourses['lastPage'], 5); @endphp
    ...
    @include('livewire.offline-course.form-modal')
    @include('livewire.offline-course.delete-modal')
    @include('livewire.offline-course.enroll-modal')
</div>