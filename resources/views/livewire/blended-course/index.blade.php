<div>
    <div class="row mb-4">
        <div class="col-12 d-flex justify-content-between align-items-center">
            <h2 class="mb-0">{{ __t('blended_course') }}</h2>
            ...
            <div class="table-responsive">
                <table class="table table-hover table-responsive-md mb-0">
                    ...
                    <tbody>
                        ...
                        @empty
                        <tr>
                            <td colspan="8" class="px-4 py-4 text-center text-muted">{{ __t('no_blended_courses') }}</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
    ...
    @include('livewire.blended-course.form-modal')
    @include('livewire.blended-course.delete-modal')
    @include('livewire.blended-course.enroll-modal')
</div>