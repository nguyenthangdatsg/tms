...
class BlendedCourse extends Component
{
    use WithFileUploads;
    ...
    {
        $moodle = app('moodle');
        $this->courses = $moodle->getTmsCourses('blended');
    }
    ...
    public function openEditModal($courseId)
    {
        ...
        if ($course) {
            ...
            $this->courseType = $course->course_type ?? 'Blended';
            $this->newImage = null;
            $this->showModal = true;
        }
    }
    ...
    public function render()
    {
        ...
        return view('livewire.blended-course', ['paginatedCourses' => $paginatedCourses]);
    }
